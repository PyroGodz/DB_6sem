...
echo Importing stored procedure dbo.allSportPlaces to Oracle
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @allsportplaces.sql
