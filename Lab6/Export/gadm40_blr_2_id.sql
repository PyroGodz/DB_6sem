...
-- For table gadm40_blr_2 for Oracle
...
ALTER TABLE gadm40_blr_2 MODIFY ogr_fid NUMBER(10,0) GENERATED ALWAYS AS IDENTITY START WITH LIMIT VALUE INCREMENT BY 1;
/
