...
echo.
echo Importing table geometry_columns to Oracle
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @geometry_columns_ddl.sql
goto:eof
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlldr userid=system/Apahar33 control=geometry_columns.ctl log=geometry_columns.log rows=1000 readsize=1048576 bindsize=1048576
