...
echo.
echo Importing table record to Oracle
...
rem Timestamp: Tue May 17 21:56:30 2022
...
rem 	record.bat table

rem To import data into the table run:
rem 	record.bat import
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @record_ddl.sql
goto:eof
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlldr userid=system/Apahar33 control=record.ctl log=record.log rows=1000 readsize=115000 bindsize=115000
