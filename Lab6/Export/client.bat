...
echo.
echo Importing table client to Oracle
...
rem Timestamp: Tue May 17 21:56:23 2022
...
rem 	client.bat table

rem To import data into the table run:
rem 	client.bat import
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @client_ddl.sql
goto:eof
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlldr userid=system/Apahar33 control=client.ctl log=client.log rows=1000 readsize=200000 bindsize=200000



echo Altering identity column to implement generate always as identity

D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @client_id.sql
goto:eof
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @client_idx.sql
goto:eof
