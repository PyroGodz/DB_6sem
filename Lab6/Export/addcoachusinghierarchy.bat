...
echo Importing stored procedure dbo.AddCoachUsingHierarchy to Oracle
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @addcoachusinghierarchy.sql
