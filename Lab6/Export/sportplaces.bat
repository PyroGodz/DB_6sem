...
echo.
echo Importing table SportPlaces to Oracle
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @sportplaces_ddl.sql
goto:eof
...
D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlldr userid=system/Apahar33 control=sportplaces.ctl log=sportplaces.log rows=1000 readsize=953000 bindsize=953000



echo Altering identity column to implement generate always as identity

D:\\app\\ora_install_user\\product\\12.1.0\\dbhome_1\\BIN\sqlplus system/Apahar33 @sportplaces_id.sql
goto:eof
